...
class _HomePageState extends State<HomePage> {
  ...
  // ── Refined palette — cool grey, not stark white ───────────
  static const Color _navBg        = Color(0xFFF4F6F9);
  static const Color _navBorder    = Color(0xFFE4E8EF);
  static const Color _activeColor  = Color(0xFF1e3a8a);
  static const Color _inactiveColor = Color(0xFF8E9BB0);
  ...
  // ═══════════════════════════════════════════════════════════════
  // BOTTOM NAV — cool grey bg + layered shadow + press animation
  // ═══════════════════════════════════════════════════════════════
  Widget _buildBottomNavBar(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          // Blue tint layer — ties to brand subtly
          BoxShadow(
  ...
  // ═══════════════════════════════════════════════════════════════
  // TOP BAR — same grey, thin border, no heavy shadow
  // ═══════════════════════════════════════════════════════════════
  Widget _buildTopBar(BuildContext context, bool isDesktop) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: _navBg,
        border: Border(bottom: BorderSide(color: _navBorder, width: 1)),
      ),
      child: Row(
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 2),
                Text(
                  pageSubtitles[_selectedIndex],
                  style: TextStyle(fontSize: 13, color: _inactiveColor),
                ),
              ],
            ),
          ),
          _NotificationBell(color: _inactiveColor, bgColor: _navBg),
        ],
      ),
    );
  }
  ...
  // ═══════════════════════════════════════════════════════════════
  // SIDEBAR — Desktop, same grey palette + left accent bar
  // ═══════════════════════════════════════════════════════════════
  Widget _buildSidebar(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _navBg,
        border: Border(right: BorderSide(color: _navBorder, width: 1)),
      ),
      child: Column(
        children: [
          // Logo
          ...
          Divider(height: 1, color: _navBorder),
          SizedBox(height: 12),
            ...
            return Padding(
              ...
              child: InkWell(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected ? _activeColor.withOpacity(0.09) : Colors.transparent,
                    borderRadius: BorderRadius.circular(10),
                  ),
                  child: Row(
                    children: [
                      ...
                      Icon(
                        isSelected ? _menuItems[index]['activeIcon'] : _menuItems[index]['icon'],
          ...
          Container(
            ...
            child: Row(
              children: [
                CircleAvatar(
                  radius: 20, backgroundColor: _activeColor,
                  child: Text('JD',
                      style: TextStyle(
                    ...
                    children: [
                      Text('John Doe',
                          style: TextStyle(
                              ...
                              color: Color(0xFF0f172a))),
                      Text('Client User',
                          style: TextStyle(fontSize: 11, color: _inactiveColor)),
                    ],
                  ),
                ),
              ],
...
// ═══════════════════════════════════════════════════════════════
// _NavItem — isolated widget for press-scale animation
// ═══════════════════════════════════════════════════════════════
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: widget.navBg, width: 1.5),
                            ),
...
// ═══════════════════════════════════════════════════════════════
// _NotificationBell — press animation
// ═══════════════════════════════════════════════════════════════
...
class _DashboardTab extends StatelessWidget {
  ...
  Widget _buildContent(BuildContext context, bool isDesktop) {
    ...
    final available = (sw - (isDesktop ? 260.0 : 0.0) -
        ...
        .clamp(200.0, double.infinity).toDouble();
  ...
  Widget _actionCard({
    ...
    required IconData icon, required Color color, required String stats,
    ...
    return ConstrainedBox(
      ...
      child: InkWell(
        ...
        child: Container(
          width: width, padding: EdgeInsets.all(24),
          decoration: BoxDecoration(
  ...
  Widget _statCard(BuildContext context, String label, String value,
    ...
    final width = isDesktop
        ? ((sw - 260.0 - 64.0 - 48.0).clamp(0.0, double.infinity) / 4.0).clamp(100.0, 300.0)
        : ((sw - 32.0 - 16.0).clamp(0.0, double.infinity) / 2.0).clamp(100.0, 300.0);
    return ConstrainedBox(
