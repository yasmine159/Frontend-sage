...
class _LoginPageState extends State<LoginPage> with TickerProviderStateMixin {
  ...
  @override
  void dispose() { _slideController.dispose(); emailController.dispose(); passController.dispose(); super.dispose(); }
  ...
  void _googleSignIn() {
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content: Row(children: [
        ...
        Text('Connexion Google bientôt disponible', style: TextStyle(fontSize: 13)),
      ]),
      ...
      Expanded(flex: 55, child: Stack(fit: StackFit.expand, children: [
        ...
        Positioned(left: 44, bottom: 44, child: Column(
          crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('Connectez-vous pour accéder à votre espace.', style: TextStyle(fontSize: 14, color: _textMid)),
          ])),
      ])),
  ...
  Widget _buildForm() {
    return Form(key: _formKey, child: Column(
      crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
        ...
        Text('Entrez vos identifiants pour continuer.', style: TextStyle(fontSize: 13, color: _textMid)),
    ...
    return SizedBox(width: double.infinity, height: 48,
      child: OutlinedButton(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text('Continuer avec Google', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500, color: _textDark)),
        ]),
      ));
  }
